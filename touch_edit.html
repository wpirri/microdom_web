...
<div id='touch_edit_back_btn' class='back-btn' onclick="window.location.replace('touch_list.php');" >
...
<script type="text/javascript" >
    ...
    function LoadHWData(msg) {
        ...
        newAJAXCommand('/cgi-bin/abmtouch.cgi?funcion=get&Id=<?php echo $_GET['Id']; ?>', LoadData, false);
    }
